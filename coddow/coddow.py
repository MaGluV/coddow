...
from models.comics import Comics_Data
from services.comdb import DB_Comics
from services.findcom import FindComics
from models.ac_model import AC_Model
from models.mk_model import MK_Model
import requests
import os
import glob
import shutil
...
class Acrylic:
	...
	def start(self):
		...
		if not os.path.exists(general["comics_main_dir"]):
			os.mkdir(general["comics_main_dir"])
